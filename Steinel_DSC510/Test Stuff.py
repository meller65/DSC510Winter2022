...
if ft_of_cable > 100:
    install_cost = .80
    print('You will receive a 8% discount for such a large purchase!\n')
elif ft_of_cable > 250:
    install_cost = .70
    ...
    print( 'Are you sure? If you buy more than 100 feet you will receive a discount.')
    cus_rep = (input('Would you like to increase your order? y or n\n '))
        if cus_rep = n
        install_cost = .87
        print('Thank you.\n')
        elif cus_rep = y
